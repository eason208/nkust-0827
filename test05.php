...
<form method="POST" action="test05.php">
	本金:<input type="text" size="15" name="money" value="1000000">元<br>
    利率:<input type="text" size="15" name="rate" value="2.4">%<br>
	期數:<input type="text" size="15" name="years" value="1">年<br>
